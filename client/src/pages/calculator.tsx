    ...
    <div className="min-h-screen nc-bg relative overflow-hidden">
      ...
      <div className="bg-slate-800 text-white text-center py-2 px-4">
        <p className="text-[11px] sm:text-xs font-medium tracking-wide">
          ...
          Accurate estimates for all 50 states — free forever, no signup required{' '}
          <span className="text-emerald-400">★</span>
        </p>
      </div>
      ...
      <div className="text-center pt-6 pb-4 px-4">
        ...
        {/* Trust strip */}
        <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-1 mt-3 text-[11px] sm:text-xs text-slate-400">
          <span className="flex items-center gap-1.5">
            <svg className="w-3.5 h-3.5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
            Built by a licensed broker with 10+ years of experience
          </span>
            ...
            <Card className="shadow-lg border-0">
              <CardContent className="p-6 space-y-4">
                ...
                <div className="bg-slate-50/80 border border-slate-100 rounded-lg px-4 py-3">
                  <button
                    type="button"
                    onClick={() => setConcessionsRepairsOpen(!concessionsRepairsOpen)}
                    className="w-full flex items-center justify-between"
                  >
                    <p className="text-[11px] font-medium text-slate-400 uppercase tracking-wide">Concessions & Repairs</p>
                    <motion.div animate={{ rotate: concessionsRepairsOpen ? 180 : 0 }} transition={{ duration: 0.2 }}>
                      <ChevronDown className="w-4 h-4 text-slate-400" />
                    </motion.div>
                  </button>
                  {!concessionsRepairsOpen && (
            ...
            <div className="bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] px-4 py-2.5">
              <div className="flex items-center justify-between max-w-md mx-auto">
                ...
                <div className="w-12 h-12 shrink-0 flex items-center justify-center">
                  <PieChart width={48} height={48} style={{ overflow: 'visible' }}>
                    <Pie
                      data={chartData}
                      cx={24}
                      cy={24}
